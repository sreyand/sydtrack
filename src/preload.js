...
contextBridge.exposeInMainWorld('sydtrack', {
  ...
  getBrowserKeywords: () => ipcRenderer.invoke('browserKeywords:get'),
  setBrowserKeywords: (keywords) => ipcRenderer.invoke('browserKeywords:set', keywords),
  resetBrowserKeywords: () => ipcRenderer.invoke('browserKeywords:reset'),
  exportBrowserKeywords: () => ipcRenderer.invoke('browserKeywords:export'),
  importBrowserKeywords: () => ipcRenderer.invoke('browserKeywords:import'),
  ...
  deleteAllMyData: () => ipcRenderer.invoke('data:deleteAll'),
